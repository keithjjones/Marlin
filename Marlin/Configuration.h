...
#define STRING_CONFIG_H_AUTHOR "(KJJ, TAZ6-1.1.x)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "TAZ6-1.1.x"
 ...
 *                                      X, Y, Z, E0 [, E1[, E2[, E3]]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 100.5, 100.5, 3200, 850 }
